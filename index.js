...
const {
    ...
    getContentType, // تم إضافته فقط لدقة حماية الروابط
    proto
...
// 🌟 متغيرات الحماية الإضافية (لا تضر كودك الأساسي)
const activeMonitors = new Map();
const globalContacts = new Map();
const spamStore = new Map();
const DIVIDER = '━━━━━━━━━━━━━━━';

// 🌟 دالة مساعدة لجلب الأسماء والأرقام المخفية 
...
// ==========================================
// 🚀 4. معالج الأوامر (نفس كودك الأصلي بالحرف)
// ==========================================
...
async function startSession(sessionId, res = null, pairingNumber = null) {
    ...
    // إضافة إعدادات الترسانة بدون تغيير إعداداتك الأساسية
    ...
    const sock = makeWASocket({
        ...
        syncFullHistory: false, // نفس كودك
    ...
    // سحب جهات الاتصال لمعرفة الأسماء (إضافة)
    ...
    // ==========================================
    // 🔥 7. استقبال الرسائل (هنا كودك الأصلي يعمل)
    // ==========================================
    sock.ev.on('messages.upsert', async ({ messages, type }) => {
        ...
        // 🟢 متغيراتك الأصلية 100% كما أرسلتها 🟢
        ...
        const actualType = getContentType(msg.message); // جلب النوع بدقة
        ...
        // ==========================================
        // ⚔️ [صندوق الترسانة العسكري - معزول عن كودك]
        // يعمل فقط إذا كان هناك رسالة من غير البوت
        // ==========================================
            ...
            if (isViolator) {
                try {
                    ...
                    if (isBotAdmin && !isSenderAdmin) {
                        ...
                        return; // 🛑 إيقاف الكود هنا إذا تم عقاب العضو
                    }
                } catch (e) {}
            }
        }
        ...
        // ==========================================
        // 🌟 [إضافات الاستخبارات: قناص الحالات الشبح]
        // ==========================================
        ...
        // ==========================================
        // 🟢🟢 من هنا يبدأ كودك الأساسي للأوامر والذكاء 🟢🟢
        // لم يتم تغيير أو مسح أو تعديل أي حرف من هنا لأسفل!
        // ==========================================
