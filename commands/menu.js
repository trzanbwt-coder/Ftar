    ...
    execute: async ({ sock, msg, args, reply, from }) => {
        ...
        try {
            ...
            const generateImage = async (index) => {
                ...
                // المحرك سيصنع صورة خلفية داكنة مع ورود وأضواء وقلوب بناءً على الكلمات المفتاحية
                ...
                if (textPos === 'bottom') {
                     ...
                     gradient.addColorStop(1, 'rgba(0,0,0,0.95)'); // أسود داكن جداً في الأسفل
                } else if (textPos === 'top') {
